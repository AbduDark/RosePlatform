...
class NotificationController extends Controller
{
    ...
    public function unreadCount()
    {
        try {
            $user = Auth::user();
            if (!$user) {
                return $this->successResponse(['count' => 0], 'تم جلب عدد الإشعارات غير المقروءة');
            }
    ...
    public function statistics()
    {
        try {
            ...
            $thisWeekNotifications = Notification::whereBetween('created_at', [
                now()->startOfWeek(), 
                now()->endOfWeek()
            ])->count();
            
            $thisMonthNotifications = Notification::whereMonth('created_at', now()->month)
            ...
            return $this->successResponse([
                ...
                'this_month_notifications' => $thisMonthNotifications,
    ...
    public function sendNotification(Request $request)
    {
        try {
            ...
            $validator = Validator::make($request->all(), [
                ...
                'type' => 'required|in:general,course,subscription,system,admin,new_subscription',
            ...
            return $this->successResponse(null, 'تم إرسال الإشعارات بنجاح');
        } catch (\Exception $e) {
